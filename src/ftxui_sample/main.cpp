...
// configuration step. It creates a namespace called `tray_tracker`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", tray_tracker::cmake::project_name, tray_tracker::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", tray_tracker::cmake::project_version);
      return EXIT_SUCCESS;
    }
